# assets.trip.202606191345

Saigon, June 2026 — everything the trip's page on
...
```
https://cdn.jsdelivr.net/gh/Zhang-En-Yao/assets.trip.202606191345@<tag>/content.json
```
...
The 35 photographs are in `photos/`, referenced by file name from `content.json`.
...
The prose and the photographs are En-Yao's. `places.json` is derived from Wikidata (CC0).
